    ...
    <main class="client-dashboard" id="clientDashboard">
        <aside class="sidebar" aria-label="Sidebar navigation">
            ...
            <div class="sidebar-footer">
                <ul>
                    <li><a href="#" class="nav-item" aria-label="Settings"><span class="icon" aria-hidden="true"></span><span class="label">Settings</span></a></li>
                    <li><a href="/logout.php" class="nav-item" aria-label="Logout"><span class="icon" aria-hidden="true"></span><span class="label">Logout</span></a></li>
                </ul>
            </div>
        </aside>
